...
const STRUCTURE_PATH: String = "res://assets/generated/tilesets/industrial_prison/prison_wall_kit_48_v1.png"
const PROPS_PATH: String = "res://assets/generated/tilesets/industrial_prison/prison_modular_props_48_v1.png"
const OUTPUT_PATH: String = "res://assets/generated/tilesets/industrial_prison/cell_block_a2_wallkit_preview_v1.png"
...
func _initialize() -> void:
	...
	_draw_layer(output, structure_atlas, root.get_node("FloorLayer") as TileMapLayer, 0, false)
	_draw_layer(output, structure_atlas, root.get_node("WallLayer") as TileMapLayer, 0, true)
	_draw_layer(output, structure_atlas, root.get_node("DoorFrameLayer") as TileMapLayer, 0, true)
...
func _draw_layer(output: Image, atlas: Image, layer: TileMapLayer, source_id: int, blend_structure: bool = true) -> void:
	for cell in layer.get_used_cells():
		...
		if source_id == 1 or blend_structure:
